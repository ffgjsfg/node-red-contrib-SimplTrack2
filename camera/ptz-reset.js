module.exports = function(RED) {
    ...
    function PtzResetNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            let url = `http://${node.camera.ip}:${port}/cgi-bin/param.cgi?pan_tiltdrive_reset`;
    ...
    RED.nodes.registerType("simpltrack-ptz-reset",PtzResetNode);
}